...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        while (!salir) {
            try {
                ...
                //Este será el metodo ejecutarOpciones que devolverá un booleano
    ...
    // Metodo para ejecutar las opciones
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO) {
        ...
        switch (opcion) {
            ...
            default -> System.out.println("Opción no reconocida, ingresa otra opción");
        }
        return salir;
    }
} //Fin clase
